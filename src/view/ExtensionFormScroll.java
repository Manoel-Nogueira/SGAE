...
public class ExtensionFormScroll extends JPanel {
	...
	//Variável que guarda true se a tentativa de salvamento for feita
	...
	public ExtensionFormScroll() {
		...
		JButton btnButton_1 = new JButton("Salvar");
		...
		JLabel lblLabel_1 = new JLabel("FORMULÁRIO DE SUBMISSÃO DE AÇÃO DE EXTENSÃO");
			lblLabel_1.setBounds(347, 8, 673, 30);
		...
		JPanel panel_2_1 = new JPanel();
			...
			comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Programa", "Projeto", "Núcleo Temático", "Evento", "Empresa Junior", "Liga Acadêmica", "Prestação de Serviço", "Curso"}));
		...
		JLabel lblLabel_3 = new JLabel("Eventos");
			...
			comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"Congresso", "Conferência", "Seminário", "Fórum", "Simpósio", "Oficina", "Palestra", "Mesa redonda", "Encontro", "Workshop", "Feira", "Semana", "Exposição", "Festival"}));
		...
		JPanel panel_4_1 = new JPanel();
			...
			comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"Inicialização", "Atualização", "Formação", "Qualificação"}));
		...
		JPanel panel_5_1 = new JPanel();
			...
			comboBox_4.setModel(new DefaultComboBoxModel(new String[] {"Ciências da Terra", "Ciências Humanas e Ciências Sociais Aplicadas", "Ciências da Vida", "Engenharias e Ciências Exatas"}));
		...
		JPanel panel_6_1 = new JPanel();
			...
			comboBox_5.setModel(new DefaultComboBoxModel(new String[] {"Cultura", "Comunicação", "Direitos Humanos e Justiça", "Educação", "Saúde", "Meio Ambiente", "Tecnologia e Produção", "Trabalho"}));
		...
		JPanel panel_7_1 = new JPanel();
			...
			lblLabel_7.setBounds(625, 6, 117, 28);
		...
		JPanel panel_8_1 = new JPanel();
			...
			lblLabel_8.setBounds(516, 6, 335, 28);
		...
		JPanel panel_9_1 = new JPanel();
			...
			lblLabel_9.setBounds(483, 6, 401, 28);
		...
		JPanel panel_11_1 = new JPanel();
			...
			//Quando clicar em salvar transfere as escolhas feitas para um arraylist
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(comboBox_1.getSelectedItem() != null && 
					   ...
					   txtrArea_1.getText() != null
							...
							String name = txtField_2.getText();
							...
							try {
								...
								if(ExtensionFormsController.createNewForm(name, listChoices, "folderSubmissionForms")) {
	...
	//Método que seta os campos para a visualização do formulário
	public void viewExtensionForm(String fleName) {
